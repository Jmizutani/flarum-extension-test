...
return [
    ...
    (new Extend\Routes('api'))
        ...
        ->post('/profile-fields/{id:[0-9]+}/delete', 'profile-fields.delete-post', DeleteProfileFieldController::class)
        ...
        ->post('/social-links/{id:[0-9]+}/delete', 'social-links.delete-post', DeleteSocialLinkController::class)
